package ru.evgeni.microservices.core.productcompositeservice;
...
import static ru.evgeni.api.event.Event.Type.CREATE;
import static ru.evgeni.api.event.Event.Type.DELETE;
import static ru.evgeni.microservices.core.productcompositeservice.IsSameEvent.sameEventExceptCreatedAt;
...
import ru.evgeni.api.composite.product.ProductAggregate;
import ru.evgeni.api.composite.product.RecommendationSummary;
import ru.evgeni.api.composite.product.ReviewSummary;
import ru.evgeni.api.core.product.Product;
import ru.evgeni.api.core.recommendation.Recommendation;
import ru.evgeni.api.core.review.Review;
import ru.evgeni.api.event.Event;
